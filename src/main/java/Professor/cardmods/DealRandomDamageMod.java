        ...
        Wiz.atb(new AbstractGameAction() {
            ...
            public void update() {
                ...
                if (mon!= null) {
                    ...
                    Wiz.att(new InfusionTriggerAction(DealRandomDamageMod.this, damage, baseVal == relicStatsVal ? damage : damage - Professor.util.CalcHelper.calculateCardDamage(baseVal - relicStatsVal, mon)));
                }
                this.isDone = true;
            }
        });
