...
import Professor.cards.creations.IceBomb;
...
public class SynthesizeIceBomb extends AbstractRecipeCard {
    public final static String ID = makeID(SynthesizeIceBomb.class.getSimpleName());

    public SynthesizeIceBomb() {
        super(ID, 1, CardType.SKILL, CardRarity.COMMON, CardTarget.SELF);
        baseMagicNumber = magicNumber = 2;
        cardsToPreview = new IceBomb();
    }
    ...
    public AbstractCreationCard getCreation(int red, int blue, int yellow, int green) {
        return new IceBomb(new AbstractCreationCard.ElementData(red, blue, yellow, green));
    }
}