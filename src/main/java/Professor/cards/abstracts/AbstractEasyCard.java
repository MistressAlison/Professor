...
public abstract class AbstractEasyCard extends CustomCard {
    ...
    protected static final Color VERMILION = new Color(1, 0.25f, 0, 1);
    protected static final Color ORANGE = new Color(1, 0.5f, 0, 1);
    protected static final Color AMBER = new Color(1, 0.75f, 0, 1);
    protected static final Color YELLOW = new Color(1, 1, 0, 1);
    protected static final Color LIME = new Color(0.75f, 1, 0, 1);
    protected static final Color CHARTREUSE = new Color(0.5f, 1, 0, 1);
    protected static final Color HARLEQUIN = new Color(0.25f, 1, 0, 1);
    protected static final Color GREEN =  new Color(0, 1, 0, 1);
    protected static final Color ERIN = new Color(0, 1, 0.25f, 1);
    protected static final Color SPRING_GREEN = new Color(0, 1, 0.5f, 1);
    protected static final Color AQUAMARINE = new Color(0, 1, 0.75f, 1);
    protected static final Color CYAN =  new Color(0, 1, 1, 1);
    protected static final Color CAPRI = new Color(0, 0.75f, 1, 1);
    protected static final Color AZURE = new Color(0, 0.5f, 1, 1);
    protected static final Color CERULEAN = new Color(0, 0.25f, 1, 1);
    protected static final Color BLUE = new Color(0, 0, 1, 1);
    protected static final Color INDIGO = new Color(0.25f, 0, 1, 1);
    protected static final Color VIOLET = new Color(0.5f, 0, 1, 1);
    protected static final Color PURPLE = new Color(0.25f, 0, 1, 1);
    protected static final Color MAGENTA = new Color(1, 0, 1, 1);
    protected static final Color CERISE = new Color(1, 0, 0.75f, 1);
    protected static final Color ROSE = new Color(1, 0, 0.5f, 1);
    protected static final Color CRIMSON = new Color(1, 0, 0.25f, 1);
