...
import Professor.powers.NextTurnPowerPower;
...
public class Wiz {
    ...
    public static void flatOneDamage(AbstractMonster m) {
        m.damage(new DamageInfo(adp(), 1, DamageInfo.DamageType.THORNS));
    }

    public static void flatOneBlock() {
        adp().addBlock(1);
    }
}
