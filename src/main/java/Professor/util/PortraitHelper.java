...
public class PortraitHelper {
    ...
    private static final Texture attackMask = TexLoader.getTexture("ProfessorResources/images/masks/AttackMask.png");
    private static final Texture skillMask = TexLoader.getTexture("ProfessorResources/images/masks/SkillMask.png");
    private static final Texture powerMask = TexLoader.getTexture("ProfessorResources/images/masks/PowerMask.png");
