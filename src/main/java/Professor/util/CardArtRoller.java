...
public class CardArtRoller {
    private static final Texture attackMask = TexLoader.getTexture(MainModfile.makeImagePath("masks/AttackMask.png"));
    private static final Texture skillMask = TexLoader.getTexture(MainModfile.makeImagePath("masks/SkillMask.png"));
    private static final Texture powerMask = TexLoader.getTexture(MainModfile.makeImagePath("masks/PowerMask.png"));
