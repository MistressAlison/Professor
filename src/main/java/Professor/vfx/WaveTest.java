...
public class WaveTest implements ScreenPostProcessor {
    public static ShaderProgram sp = new ShaderProgram(SpriteBatch.createDefaultShader().getVertexShaderSource(), Gdx.files.internal(MainModfile.makePath("shaders/ascii2.frag")).readString(String.valueOf(StandardCharsets.UTF_8)));
