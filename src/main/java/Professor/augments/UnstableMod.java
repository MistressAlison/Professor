...
public class UnstableMod extends AbstractAugment implements DynvarCarrier {
    public static final String ID = MainModfile.makeID(UnstableMod.class.getSimpleName());
    ...
    public void onUse(AbstractCard card, AbstractCreature target, UseCardAction action) {
        addToBot(new ApplyPowerAction(target, AbstractDungeon.player, new UnstablePower(target, getBaseVal(card))));
    }
