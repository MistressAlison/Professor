...
import Professor.util.matcher.BasicMatchChecker;
import Professor.util.matcher.CompoundMatcher;
import Professor.util.matcher.OverrideMatcher;
import Professor.util.matcher.PowerTypeMatcher;
import basemod.Pair;
...
public class ArchetypeHelper {
    ...
    public static Class<?>[] importantSuperClasses = {AbstractGameAction.class, AbstractPower.class, AbstractOrb.class};
